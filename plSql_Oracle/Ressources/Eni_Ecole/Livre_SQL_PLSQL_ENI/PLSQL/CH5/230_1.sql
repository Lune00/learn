-- Exemple d'utilisation du package DBMS_LOB
drop table mesphotos;
drop sequence seq_id_photos;
...
--    insert into mesphotos values (seq_id_photos.nextval, dest_blob);
    commit;
